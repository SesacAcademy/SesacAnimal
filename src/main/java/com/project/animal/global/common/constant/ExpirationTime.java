...
public abstract class ExpirationTime {
    ...
    // JWT 토큰
    public static final Long ACCESS_TOKEN_EXPIRATION_TIME = 1000 * 60 * 10L;           // 밀리 초 단위 (10분)
    public static final Long REFRESH_TOKEN_EXPIRATION_TIME = 1000 * 60 * 60 * 3L;      // 밀리 초 단위 (3시간)

    // HTTP 쿠키
    public static final Long ACCESS_TOKEN_COOKIE_EXPIRATION_TIME = 10L;                // 분 단위
    public static final Long REFRESH_TOKEN_COOKIE_EXPIRATION_TIME = 60L * 3;           // 분 단위
