...
public class MissingPostDummy {
  private static List<MissingPost> dummyPost = List.of(
          new MissingPost(1, 1,"Lost Friendly Dog, faepoefjawpofawpofjawfeawfoawpj", "dog","persian", "Brown", 150, "Central Park", LocalDateTime.now(), "Sma dog with a red collar and a friendly demeanor.", 0, 'L', true),
          new MissingPost(1, 1,"Lost Friendly Dog", "dog", "persian","Brown", 150, "Central Park", LocalDateTime.now(), "Sma dog with a red collar and a friendly demeanor.", 0, 'L', true),
          new MissingPost(1, 1,"Lost Friendly Dog", "dog","persian", "Brown", 150, "Central Park", LocalDateTime.now(), "Sma dog with a red collar and a friendly demeanor.", 0, 'L', true),
          new MissingPost(1, 1,"Lost Friendly Dog", "dog", "persian","Brown", 150, "Central Park", LocalDateTime.now(), "Sma dog with a red collar and a friendly demeanor.", 0, 'L', true),
          new MissingPost(1, 1,"Lost Friendly Dog", "dog","persian", "Brown", 150, "Central Park", LocalDateTime.now(), "Sma dog with a red collar and a friendly demeanor.", 0, 'L', true),
          new MissingPost(1, 1,"Lost Friendly Dog", "dog", "persian","Brown", 150, "Central Park", LocalDateTime.now(), "Sma dog with a red collar and a friendly demeanor.", 0, 'L', true),
